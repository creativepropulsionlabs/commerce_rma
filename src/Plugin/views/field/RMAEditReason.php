 ...
 */
class RMAEditReason extends FieldPluginBase {
  ...
  public function viewsForm(array &$form, FormStateInterface $form_state) {
    ...
    $options = [];
    /** @var RMAReasonInterface[] $reasons */
    $reasons = $this->entityTypeManager->getStorage('commerce_rma_reason')->loadMultiple();
  ...
  public function viewsFormSubmit(array &$form, FormStateInterface $form_state) {
    // Do nothing. All logic in RMAEditQuantity.
  }
